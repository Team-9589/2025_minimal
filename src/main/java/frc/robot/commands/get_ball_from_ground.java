...
public class get_ball_from_ground extends Command {

    private final elevator_subsystem elevator; 
    private final big_ball_thingy_subsystem big_ball_thingy;

    public get_ball_from_ground(elevator_subsystem elevator_subsystem, big_ball_thingy_subsystem big_ball_thingy_subsystem){
    ...
    public void execute() {
        ...
        elevator.move_to_ground_intake();
        big_ball_thingy.move_arm_to_ground_intake();
